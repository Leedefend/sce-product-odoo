...
def _fail(errors: list[str]) -> int:
    print("[page_contract_role_strategy_provider_split_guard] FAIL")
    for err in errors:
        print(f"- {err}")
    return 1
...
def main() -> int:
    ...
    required_provider_tokens = [
        "def build_role_section_policy(role_code: str)",
        "def build_role_zone_order(role_code: str, page_type: str, page_key: str = \"\")",
        "def build_role_focus_sections(role_code: str, page_key: str)",
    ]
    ...
    print("[page_contract_role_strategy_provider_split_guard] PASS")
    return 0
