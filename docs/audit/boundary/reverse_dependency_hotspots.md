# Reverse Dependency Hotspots (Phase D-2 / Screen)

- Stage: `screen` (ranking from existing dependency artifacts only)
- Input: `docs/audit/boundary/file_dependency_hotspots.md`
...
- Ranking is derived from outbound cross-module import count in D-1 artifact.
- Additional ownership and migration decisions are deferred to later governance batches.
